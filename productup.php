...
<?php include('pmodel_add.php'); ?>
                                     ...
                                     <th style="text-align:center;">per_unit_price</th>
                                      <th style="text-align:center;">e_date</th>
                                       <th style="text-align:center;">m_date</th>
                                        <th style="text-align:center;">Deleted Product</th>
                ...
                <td style="text-align:center; word-break:break-all; width:500px;"><a href="deleteproduct.php">Click here</a>;</td>
